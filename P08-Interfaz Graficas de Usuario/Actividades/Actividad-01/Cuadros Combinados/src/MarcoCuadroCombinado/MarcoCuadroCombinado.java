...
public class MarcoCuadroCombinado extends JFrame {
    ...
    private static final String nombres[] = {"insecto1.png", "insecto2.png", "insectviaje.png", "insectanim.png"};
...
// El constructor de MarcoCuadroCombinado agrega un objeto JComboBox a JFrame
    public MarcoCuadroCombinado() {
        super("CUADRO COMBINADO");
        setLayout(new FlowLayout()); // establece el esquema del marco
        JComboBox<String> imagenesJComboBox = new JComboBox<String>(nombres); // establece JComboBox
        ...
        {
// maneja evento de JComboBox @Override
