...
public class MarcoSeleccionMultiple extends JFrame {
    ...
    private final JList<String> listaJListCopia; // lista en la que se van a copiarlos
    //nombres de los colores
    private JButton botonJButtonCopiar; // botón para copiar los nombres seleccionados
    private static final String[] nombresColores = {"Negro", "Azul", "Cyan", "Gris oscuro",
...
// Constructor de MarcoSeleccionMultiple
    public MarcoSeleccionMultiple() {
        super("listas multiples");
        setLayout(new FlowLayout());
        JList<String> listaJListColores = new JList<String>(nombresColores);
...
// maneja evento de botón
        ...
        listaJListCopia.setFixedCellHeight(15); // establece la altura listaJListCopia.setSelectionMode(
